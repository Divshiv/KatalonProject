...
def tearDown() {
	println "Running Tear Down method"
}
...
def setupTestCase() {
	println "Running Setup method for each test case"
}
...
def tearDownTestCase() {
	println "Running tear down method for each test case"
}
